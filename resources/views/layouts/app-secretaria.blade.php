...
<div class="wrapper">
    ...
    <aside id="studentSidebar" class="main-sidebar elevation-4">
        ...
        <div class="sidebar-bg"
             style="background-image: url('{{ asset('images/Edificio2.jpeg') }}');">
        </div>
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column dashboard-menu"
                        ...
                        <li class="nav-item has-treeview {{ $menuRevisionOpen ? 'menu-open' : '' }}">
                            ...
                            <a href="javascript:void(0)"
                               class="nav-link {{ $menuRevisionOpen ? 'active' : '' }}">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="{{ $equivalenciasUrl }}"
                                       class="nav-link {{ $menuEquivalenciasActive ? 'active' : '' }}">
                        ...
                        <li class="nav-item">
                            <a href="{{ $respaldoUrl }}"
                               class="nav-link {{ $respaldoActive ? 'active' : '' }}">
                ...
                <div class="student-topbar-right">
                    ...
                    <div class="topbar-action-group">
                        ...
                        <button class="topbar-icon-btn"
                            ...
                            <span class="topbar-badge notif-hidden"
                                  id="notifBadge">
                            </span>
                        ...
                        <div class="topbar-dropdown"
                            ...
                            <div class="topbar-dropdown-header">
                                ...
                                <a href="#"
                                   class="topbar-dropdown-mark"
                                   id="btnMarcarTodasNotif">
                    ...
                    <div class="topbar-action-group">
                        ...
                        <button class="student-user-chip"
                                id="btnUser"
                                title="Mi perfil">
                            ...
                            <div class="student-user-chip-info">
                                ...
                                <span class="student-user-chip-name">
                                    {{ $displayName }}
                                </span>

                                <span class="student-user-chip-role">
                                    {{ $displayRole }}
                                </span>
                        ...
                        <div class="topbar-dropdown align-right user-profile-dropdown"
                             id="dropUser">
                            ...
                            <div class="user-dropdown-body">
                                ...
                                <a href="{{ url('/secretaria-carrera/mi-perfil') }}"
        ...
        <div class="modal-content">
            ...
            <div class="session-timeout-body">
                ...
                <div class="session-timeout-countdown">
                    ...
                    <span>
                        Se cerrará en
                        <span id="sessionCountdownText">60</span>
                        segundos
                    </span>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const mensajesApiUrl =
        '{{ $mensajesRecientesUrl }}';

    const topbarBadge =
        document.getElementById('mensajesTopbarBadge');

    const sidebarBadge =
        document.getElementById('sidebarMensajesBadge');

    const mensajesList =
        document.getElementById('mensajesTopbarList');
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const btnMarcarTodas =
        document.getElementById('btnMarcarTodasNotif');

    const URL_NOTIF_RECIENTES =
        "{{ url('/api/notificaciones/recientes') }}";

    const URL_MARCAR_TODAS =
        "{{ url('/api/notificaciones/marcar-todas-leidas') }}";

    const URL_ABRIR_BASE =
    ...
    function normalizarColor(color) {
        ...
        return permitidos.includes(color)
            ? color
            : 'blue';
        ...
        notifList.innerHTML =
            notificaciones.map((notif) => {
                ...
                const mensaje =
                    escaparHtml(
                        notif.mensaje
                        || 'Tienes una actualización pendiente.'
                    );
                ...
                const abrirUrl =
                    `${URL_ABRIR_BASE}/${encodeURIComponent(id)}`;
    ...
    if (btnMarcarTodas) {
        ...
        btnMarcarTodas.addEventListener(
            'click',
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const STORAGE_WIDTH_KEY =
        'student_sidebar_width';

    const STORAGE_COLLAPSE_KEY =
    ...
    async function forceLogoutByInactivity() {
        ...
        try {
            ...
            if (!response.ok) {
                ...
                throw new Error(
                    'No se pudo cerrar la sesión automáticamente.'
                );
